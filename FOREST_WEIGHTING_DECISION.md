...
[compatibility weighting plan](../../FISHHIGHZ_COMPATIBILITY_WEIGHTING_PLAN.md).
The [historical findings](LYAFORECAST_WEIGHTING_FINDINGS.md) document the
...
| --- | --- | --- | --- |
| Step 1 | [Variant/control report](reviews/compatibility-weighting-stage1.md) | [Review](reviews/compatibility-weighting-stage1-review.md) | [Baseline](.validation/compatibility-weighting-stage1/baseline.json) |
| Step 2 | [Trajectory/grid report](reviews/compatibility-weighting-stage2.md) | [Review](reviews/compatibility-weighting-stage2-review.md) | [Summary and per-bin trajectories](.validation/compatibility-weighting-stage2/) |
| Step 3 | [Adaptive stopping report](reviews/compatibility-weighting-stage3.md) | [Review](reviews/compatibility-weighting-stage3-review.md) | [Summary and per-bin checks](.validation/compatibility-weighting-stage3/) |
| Step 4 | [15×2pt BAO report](reviews/compatibility-weighting-stage4.md) | [Review](reviews/compatibility-weighting-stage4-review.md) | [Forecasts, changes and eleven figures](.validation/compatibility-weighting-stage4/) |
| Step 5 additional check | [Early-weight grid-to-BAO report](reviews/early-lyaforecast-grid-bao.md) | [Review](reviews/early-lyaforecast-grid-bao-review.md) | [Forecasts, changes and two figures](.validation/early-lyaforecast-grid-bao/) |
...
[Step-12 revision-5 compatibility bundle](.validation/step12-r5-20260914T191855Z/profiles-checked/).

Relevant implementations are the
[weight variants](fishhighz/validation/compatibility_weights.py),
[trajectory diagnostics](fishhighz/validation/weight_convergence.py),
[adaptive stopping](fishhighz/validation/adaptive_weights.py),
[BAO reassembly](fishhighz/validation/compatibility_bao.py), and
[grid-to-BAO calculation](scripts/check_early_lyaforecast_grid_bao.py).
