...
Read AGENTS.md (local-only path: `AGENTS.md`), design section 0 and weighting conventions (local-only path: `../../FISHHIGHZ_DESIGN.md`),
the roadmap (local-only path: `../../FISHHIGHZ_IMPLEMENTATION_PLAN.md`), the
planning assessment (local-only path: `reviews/step-13-planning-r1.md`),
r6 handoff (local-only path: `reviews/step-12.md`), r6 review (local-only path: `reviews/step-12-review-r6.md`), and the
r5 scientific diagnosis (local-only path: `reviews/step-12-r5.md`). The previous active assignment
is preserved in step-12-instructions-r6.md (local-only path: `reviews/step-12-instructions-r6.md`).
