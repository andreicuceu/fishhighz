...
independent review (local-only path: `reviews/step-12-review-r2.md`), plus the
revision-4 handoff (local-only path: `reviews/step-12-performance-r4.md`) and
revision-4 review (local-only path: `reviews/step-12-review-r4.md`). Implement this step only when
