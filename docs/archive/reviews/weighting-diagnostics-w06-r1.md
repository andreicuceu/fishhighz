...
New script: compare_forest_weight_refinement.py (local-only path: `../scripts/compare_forest_weight_refinement.py`).
New output: summary.json (local-only path: `../.validation/forest-weight-diagnostics/w06-r1-20260915T234041Z/summary.json`).
