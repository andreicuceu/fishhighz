...
below is unchanged. See review (local-only path: `reviews/weighting-diagnostics-w06-review-r1.md`)
and original instructions (local-only path: `reviews/weighting-diagnostics-w06-instructions-r1.md`).
