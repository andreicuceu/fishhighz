...
the diagnostic roadmap (local-only path: `../../FISHHIGHZ_WEIGHTING_DIAGNOSTICS_PLAN.md`),
W06 review (local-only path: `reviews/weighting-diagnostics-w06-review-r1.md`),
W07 review (local-only path: `reviews/weighting-diagnostics-w07-review-r1.md`), and
W09 review (local-only path: `reviews/weighting-diagnostics-w09-review-r1.md`). Inspect only the
