...
Status: implemented; independent scientific review passes. Awaiting user review
and acceptance; no progression is authorized. No consequential correction is
needed. See reviews/weighting-diagnostics-w07-review-r1.md. W06 passes
independent scientific review; the user requested W07. This is
...
W06 report (local-only path: `reviews/weighting-diagnostics-w06-r1.md`),
W06 review (local-only path: `reviews/weighting-diagnostics-w06-review-r1.md`), and the fixed-weight
and individual-spectrum paragraphs in the
Step 12 r5 report (local-only path: `reviews/step-12-r5.md`) and
review (local-only path: `reviews/step-12-review-r5.md`). W05 supplies the reference derivation.
The reviewed W06 instructions (local-only path: `reviews/weighting-diagnostics-w06-instructions-reviewed-r1.md`)
