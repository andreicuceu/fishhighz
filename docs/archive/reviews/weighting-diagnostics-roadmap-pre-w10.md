...
This investigation is separate from the package roadmap (local-only path: `FISHHIGHZ_IMPLEMENTATION_PLAN.md`).
...
Agent prompts (local-only path: `FISHHIGHZ_WEIGHTING_DIAGNOSTICS_PROMPTS.md`) select W09. Approval
...
- W01 revision-3 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w01-instructions-r3.md`)
  preserve the former current-step file byte for byte.
- Pre-W02 roadmap (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-roadmap-pre-w02.md`)
...
- Original W02 r1 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w02-instructions-r1.md`)
  and reviewed W02 r1 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w02-instructions-reviewed-r1.md`)
  preserve its original assignment and the status after independent review.

- Original W03 r1 assignment (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w03-instructions-r1.md`)
  and reviewed W03 r1 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w03-instructions-reviewed-r1.md`)
  preserve the scientific assignment and the subsequent review status.

- Original W04 r1 assignment (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w04-instructions-r1.md`)
  and reviewed W04 r1 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w04-instructions-reviewed-r1.md`)
  preserve the assignment and its status after independent review.

- Original W05 r1 assignment (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w05-instructions-r1.md`)
  and reviewed W05 r1 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w05-instructions-reviewed-r1.md`)
  preserve the assignment and its status after independent review.

- Original W06 r1 assignment (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w06-instructions-r1.md`)
  and reviewed W06 r1 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w06-instructions-reviewed-r1.md`)
  preserve the assignment and its status after independent review. No repair
  revision was required.

- Original W07 r1 assignment (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w07-instructions-r1.md`)
  and reviewed W07 r1 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w07-instructions-reviewed-r1.md`)
  preserve the assignment and its status after independent review. No repair
  revision was required.

- Original W08 r1 assignment (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w08-instructions-r1.md`)
...
- Exact W08 r2 assignment (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w08-instructions-r2.md`)
  preserves the implemented repair instructions. The
  revision-2 review (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w08-review-r2.md`)
  closes W08-R1 without requesting another revision.

- Reviewed W08 r2 instructions (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w08-instructions-reviewed-r2.md`)
  and W08 prompts (local-only path: `lib/fishhighz/reviews/weighting-diagnostics-w08-prompts-reviewed-r2.md`)
