...
read the diagnostic roadmap (local-only path: `../../FISHHIGHZ_WEIGHTING_DIAGNOSTICS_PLAN.md`),
W07 review (local-only path: `reviews/weighting-diagnostics-w07-review-r1.md`),
W08 r2 review (local-only path: `reviews/weighting-diagnostics-w08-review-r2.md`), and only relevant
