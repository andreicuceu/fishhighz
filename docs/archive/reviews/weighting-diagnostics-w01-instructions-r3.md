...
the revision-1 handoff (local-only path: `reviews/weighting-diagnostics-w01-r1.md`), its evidence,
and the revision-1 review (local-only path: `reviews/weighting-diagnostics-w01-review-r1.md`).
...
the revision-2 handoff (local-only path: `reviews/weighting-diagnostics-w01-r2.md`), its evidence,
and the revision-2 review (local-only path: `reviews/weighting-diagnostics-w01-review-r2.md`).
...
and the diagnostic roadmap (local-only path: `../../FISHHIGHZ_WEIGHTING_DIAGNOSTICS_PLAN.md`).
