...
check.py (local-only path: `../.validation/forest-weight-diagnostics/w11-review-r1-20260916T045000Z/check.py`),
with full-precision output in
result.json (local-only path: `../.validation/forest-weight-diagnostics/w11-review-r1-20260916T045000Z/result.json`).
