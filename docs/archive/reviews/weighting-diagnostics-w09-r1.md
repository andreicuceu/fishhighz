...
The script (local-only path: `../scripts/replay_inverse_variance_bao.py`) has SHA-256
`135cd6bbe06736a7b042b9aff80c643f0a0fbabd1ab6c81828829b1e7309a811`.
The small result.json (local-only path: `../.validation/forest-weight-diagnostics/w09-r1-20260916T015605976471Z/result.json`)
...
git-status.txt (local-only path: `../.validation/forest-weight-diagnostics/w09-r1-20260916T015605976471Z/git-status.txt`)
