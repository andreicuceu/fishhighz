...
[Revision 2 instructions](../notes/IMPLEMENTATION_STEP.md) retain the original scope
...
Locations: kernels/weights.py:25 (local-only path: `../fishhighz/kernels/weights.py#L25`) and
weights.py:282 (local-only path: `../fishhighz/weights.py#L282`).
