...
Evidence directory:
W08 evidence (local-only path: `../.validation/forest-weight-diagnostics/w08-r1-20260916T002747Z/`).
The check script (local-only path: `../.validation/forest-weight-diagnostics/w08-r1-20260916T002747Z/check_saved.py`)
and result (local-only path: `../.validation/forest-weight-diagnostics/w08-r1-20260916T002747Z/saved-result.json`)
...
pytest.log (local-only path: `../.validation/forest-weight-diagnostics/w08-r1-20260916T002747Z/pytest.log`)
