...
W03 r1 instructions (local-only path: `reviews/weighting-diagnostics-w03-instructions-r1.md`);
see the independent review (local-only path: `reviews/weighting-diagnostics-w03-review-r1.md`).
