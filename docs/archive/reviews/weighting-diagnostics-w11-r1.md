...
The script (local-only path: `../scripts/check_forest_reference_mode.py`) has SHA-256
`211c482cec8c0e6f4e1d538603e1017e27761686860fb93c7a800613370850ed`.
The only numerical output is
result.json (local-only path: `../.validation/forest-weight-diagnostics/w11-r1-20260916T044318380696Z/result.json`),
