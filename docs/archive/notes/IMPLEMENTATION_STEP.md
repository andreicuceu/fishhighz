...
Read AGENTS.md (local-only path: `AGENTS.md`), [design section 0 and weighting conventions](../planning/FISHHIGHZ_DESIGN.md),
the [roadmap](../planning/FISHHIGHZ_IMPLEMENTATION_PLAN.md), the
