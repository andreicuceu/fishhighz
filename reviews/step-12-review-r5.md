...
in [.validation/step12-review-r5](../.validation/step12-review-r5/). No real
...
metrics/verdict.** At [trials.py:170](../fishhighz/validation/trials.py#L170),
the metric/trial comparison passes the entire 15-spectrum Fisher stack to
[schema.py:203](../fishhighz/validation/schema.py#L203). Its global relative norm
allows dominant spectra to hide inconsistencies in a weak spectrum. The
[replay check](../fishhighz/validation/trials.py#L217) omits the replayed numerical
...
[weak_pair_probe.py](../.validation/step12-review-r5/weak_pair_probe.py) gives one
...
[weak-pair-probe.json](../.validation/step12-review-r5/weak-pair-probe.json) records
...
The [revision-6 instructions](../IMPLEMENTATION_STEP.md) specify these checks.
...
The [joint comparison](../.validation/step12-r5-20260914T191855Z/plots/lya_qso_lbg_lae_15x2pt.png)
and [magnitude-convergence figure](../.validation/step12-r5-20260914T191855Z/weight-figures/magnitude-convergence.png)
...
[15 individual-spectrum pages](../.validation/step12-r5-20260914T191855Z/plots/lya_qso_lbg_lae_15x2pt-pairs.pdf),
[attribution](../.validation/step12-r5-20260914T191855Z/attribution/lya_qso_lbg_lae_15x2pt.png)
and [sensitivity figure](../.validation/step12-r5-20260914T191855Z/sensitivities/lya_qso_lbg_lae_15x2pt.png)
