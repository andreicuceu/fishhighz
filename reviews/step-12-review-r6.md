...
saved results against the [revision-6 instructions](../IMPLEMENTATION_STEP.md).
The exact reviewed instructions, handoff, initial source hashes and governance
are snapshotted in [.validation/step12-review-r6](../.validation/step12-review-r6/).
...
[original-probe.json](../.validation/step12-review-r6/original-probe.json) records
...
A separate [Decimal oracle](../.validation/step12-review-r6/range_review.py)
