...
[scalar_check.py](../.validation/forest-weight-diagnostics/w06-review-r1-independent/scalar_check.py)
and [result.json](../.validation/forest-weight-diagnostics/w06-review-r1-independent/result.json).
