...
New outputs:
[summary.json](../.validation/forest-weight-diagnostics/w05-r1-20260915T231931Z/summary.json)
(9.3 KiB) records the full table, 80-digit values, checks, scalars, timings and
source hashes;
[arrays.npz](../.validation/forest-weight-diagnostics/w05-r1-20260915T231931Z/arrays.npz)
(12 KiB) retains the three input arrays, four weights and display shapes.
The only new Python is
[compare_inverse_variance_forest_weights.py](../scripts/compare_inverse_variance_forest_weights.py).
