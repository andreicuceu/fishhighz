...
[Revision 4](../IMPLEMENTATION_STEP.md) is proposed for user approval/dispatch.
...
[the r2 manifest](../.validation/step12-r2-implementation/profiles-streamed/manifest.json)
is saved with its hash in
[historical-timings.json](../.validation/step12-performance-plan-r4/historical-timings.json).
...
[Script](../.validation/step12-performance-plan-r4/assess.py),
[raw timings and numerical checks](../.validation/step12-performance-plan-r4/assessment.json),
[log](../.validation/step12-performance-plan-r4/assessment.log), and
[cProfile table](../.validation/step12-performance-plan-r4/profile.txt)
...
1. [factor_covariance](../fishhighz/fisher.py:31) loops over cells, invoking
   [inspect_information](../fishhighz/_information.py:11) separately on every
...
2. [fisher_from_factors](../fishhighz/fisher.py:82) validates/copies per-cell
...
3. [Field PSD validation](../fishhighz/covariance.py:60) loops over small
...
4. [AccuracyRecipe.evaluate](../fishhighz/validation/accuracy.py:507) prepares
   ...
   identical production work. [study](../fishhighz/validation/accuracy.py:544)
...
5. [Evidence writing](../fishhighz/validation/evidence.py:189) calls the full
...
See [preservation-check.json](../.validation/step12-performance-plan-r4/preservation-check.json)
