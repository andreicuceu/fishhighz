...
[The diagnostic script](../scripts/check_early_lyaforecast_grid_bao.py) loads
...
[Fractional changes CSV](../.validation/early-lyaforecast-grid-bao/fractional_changes.csv)
and [JSON summary](../.validation/early-lyaforecast-grid-bao/summary.json) retain
...
[Parallel figure](../.validation/early-lyaforecast-grid-bao/parallel-refinement.png)
and [transverse figure](../.validation/early-lyaforecast-grid-bao/transverse-refinement.png)
