...
progression is implied. [Revision 3](../IMPLEMENTATION_STEP.md) specifies the
...
Evidence: [probe result](../.validation/step12-review-r2/convergence-probe.json),
[reproducer](../.validation/step12-review-r2/independent.py), and the exclusive
...
| --- | --- | ---: | ---: | ---: |
| [lbg_lae_3x2pt](../.validation/step12-r2-implementation/plots-final/lbg_lae_3x2pt.png) | LBG auto, LAE auto, LBG-LAE | -1.114 to -0.186 | -0.612 to +0.413 | 5/5 |
| [lya_lbg_lae_3x2pt](../.validation/step12-r2-implementation/plots-final/lya_lbg_lae_3x2pt.png) | F_L auto, F_L-LBG, F_L-LAE | +7.908 to +15.752 | +18.490 to +23.945 | 0/5 |
| [lya_lbg_lae_6x2pt](../.validation/step12-r2-implementation/plots-final/lya_lbg_lae_6x2pt.png) | All six spectra of F_L, LBG, LAE | +0.216 to +4.855 | +1.209 to +6.470 | 0/5 |
| [lya_qso_2x2pt](../.validation/step12-r2-implementation/plots-final/lya_qso_2x2pt.png) | F_Q auto and F_Q-QSO; QSO auto is covariance-only | -4.474 to -1.205 | -3.056 to +0.158 | 0/6 |
| [lya_qso_lbg_lae_15x2pt](../.validation/step12-r2-implementation/plots-final/lya_qso_lbg_lae_15x2pt.png) | All 15 spectra of F_Q, F_L, QSO, LBG, LAE | -3.307 to +2.365 | -0.610 to +3.318 | 0/6 |
| [lya_qso_lbg_lae_4x2pt](../.validation/step12-r2-implementation/plots-final/lya_qso_lbg_lae_4x2pt.png) | F_Q auto and its crosses with QSO, LBG, LAE | -7.248 to -3.901 | -3.503 to -0.769 | 0/6 |
| [lya_qso_lbg_lae_8x2pt](../.validation/step12-r2-implementation/plots-final/lya_qso_lbg_lae_8x2pt.png) | Both forest autos and each forest's three galaxy/QSO crosses; excludes F_Q-F_L | -6.897 to +6.285 | -2.420 to +12.563 | 0/6 |
...
Useful supplementary figures: [all cases](../.validation/step12-r2-implementation/plots-final/all-cases.png),
[LBG-forest attribution](../.validation/step12-r2-implementation/attribution-final/lya_lbg_lae_3x2pt.png),
and [15x2pt sensitivity](../.validation/step12-r2-implementation/sensitivities-final/lya_qso_lbg_lae_15x2pt.png).
